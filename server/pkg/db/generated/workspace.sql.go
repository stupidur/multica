...
func (q *Queries) ListTenantVisibleWorkspaces(ctx context.Context, homeTenantID pgtype.UUID) ([]Workspace, error) {
	rows, err := q.db.Query(ctx, listTenantVisibleWorkspaces, homeTenantID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListTenantWorkspaces(ctx context.Context, homeTenantID pgtype.UUID) ([]Workspace, error) {
	rows, err := q.db.Query(ctx, listTenantWorkspaces, homeTenantID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
